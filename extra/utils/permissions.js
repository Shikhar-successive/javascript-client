...
{
     console.log("Permission of",role,"in Module",moduleName,"of Type",permissionType,":"
                 ,permissions[moduleName].all.includes(role));              //prints true/false based on "role" present in "permissionType(all)"     
}
else
{
console.log("Permission of",role,"in Module",moduleName,"of Type",permissionType,":"
            ,permissions[moduleName][permissionType].includes(role));        //returns true/false based on "role" present in "permissionType(other than all)"
}
}
else
{
